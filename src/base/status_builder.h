...
// https://github.com/google/zetasql/blob/master/zetasql/base/status_builder.h

#ifndef SRC_BASE_STATUS_BUILDER_H_
#define SRC_BASE_STATUS_BUILDER_H_
...
//
//   StatusBuilder builder(original, SOURCE_LOC);
//   builder << "info about error";
//   return builder;
//
// It provides method chaining to simplify typical usage:
//
//   return StatusBuilder(original, SOURCE_LOC)
//       .Log(absl::log_severity::WARNING) << "oh no!";
//
// In more detail:
...
class ABSL_MUST_USE_RESULT StatusBuilder {
 public:
  ...
  StatusBuilder(absl::StatusCode code, smt::base::SourceLocation location =
  ...
  StatusBuilder(
      ...
      smt::base::SourceLocation location = SourceLocation::current());
  StatusBuilder(
  ...
  //
  // copybara:strip_begin(internal-docs)
  ...
  smt::base::SourceLocation source_location() const;
 ...
 private:
  ...
  smt::base::SourceLocation location_;
...
inline smt::base::SourceLocation StatusBuilder::source_location() const {
  return location_;
}
...
StatusBuilder& StatusBuilder::AttachPayload(const T& data) {
  absl::Cord serialized = absl::Cord(data.SerializeAsString());
  status_.SetPayload(T::descriptor()->full_name(), serialized);
  return *this;
}

}  // namespace smt::base

#endif  // SRC_BASE_STATUS_BUILDER_H_
