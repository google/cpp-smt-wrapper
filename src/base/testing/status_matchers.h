...
// https://github.com/google/zetasql/blob/master/zetasql/base/testing/status_matchers.h

#ifndef SRC_BASE_TESTING_STATUS_MATCHERS_H_
#define SRC_BASE_TESTING_STATUS_MATCHERS_H_
...
void AddFatalFailure(absl::string_view expression,
                     const ::smt::base::StatusBuilder& builder);
...
#define EXPECT_OK(expression) \
  EXPECT_THAT(expression, ::smt::base::testing::IsOk())
#define ASSERT_OK(expression) \
  ASSERT_THAT(expression, ::smt::base::testing::IsOk())
...
//
// WARNING: Like ASSIGN_OR_RETURN, ASSERT_OK_AND_ASSIGN expands into
//   multiple statements; it cannot be used in a single statement (e.g. as the
//   body of an if statement without {})!
#define ASSERT_OK_AND_ASSIGN(lhs, rexpr) \
  ASSIGN_OR_RETURN(                      \
      lhs, rexpr,                                \
      ::smt::base::testing::internal_status::AddFatalFailure(#rexpr, _))
...
#endif  // SRC_BASE_TESTING_STATUS_MATCHERS_H_
